...
export const api = {
	...
	// Sharing
	getShare: (id: string) => request("GET", `/api/agreements/${id}/share`),
	...
	signAgreement: (token: string, data: { name: string; title?: string; client_name?: string; client_address?: string; consent_text?: string; email?: string; code?: string }) =>
