	...
	document.getElementById("documentContent")!.innerHTML = `
		...
		<div class="doc-term">
			...
			<div class="doc-term-body">
				...
				<div class="doc-term-sub"><strong>Third Party Materials.</strong> Stock photography, commissioned illustrations, fonts, and similar third-party assets remain property of their respective owners. Designer shall inform Client of any licensing requirements. Client is responsible for obtaining necessary licenses at Client's expense. Client indemnifies Designer against any claims arising from Client's failure to secure required licenses for materials included in the Final Art.</div>
