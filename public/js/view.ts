	...
	document.getElementById("documentContent")!.innerHTML = `
		...
		<div class="doc-section">
			...
			<div class="doc-section-body">
				...
				<div class="doc-term-sub">(a) Coordinate any decision-making with parties other than Upland;</div>
				<div class="doc-term-sub">(b) Provide to Upland upon request all needed Client Content, including material specifications, photographs, exhibit text, and other creative content in a form suitable for reproduction or incorporation into the Project without further preparation, unless otherwise expressly provided;</div>
				<div class="doc-term-sub">(c) Provide to Upland all needed site plans, building and elevation plans, utility locations, color/material samples, and all applicable codes, rules, and regulation information that Upland is expected to adhere to;</div>
				<div class="doc-term-sub">(d) Provide and/or secure all necessary approvals for naming nomenclature which shall include, but not be limited to, end users or donors as may be necessary;</div>
				<div class="doc-term-sub">(e) Arrange and pay contractors directly for the documentation, permissions, licensing, and implementation of all electrical, structural, or mechanical elements needed to support or power signage or casework;</div>
				<div class="doc-term-sub">(f) If applicable, remove existing casework and displays that will not be incorporated into the Project;</div>
				<div class="doc-term-sub">(g) If applicable, prepare space for new exhibit ahead of installation, including, but not limited to, repairing or replacing and painting walls, doors and trim, installing or repairing floors, modifying or installing new ceiling lights;</div>
				<div class="doc-term-sub">(h) Provide final proofreading and approval of all project documents including, but not limited to, exhibit plans, production design drawings, and the Final Art, before their release for fabrication or installation. If the Client approves work containing errors or omissions, such as, by way of example, not limitation, typographic errors or misspellings, Client shall incur the cost of correcting such errors; and</div>
				<div class="doc-term-sub">(i) Assume all responsibility for compliance, with respect to the Project, with any and all applicable laws, regulations, and building codes governing non-discrimination and public accommodation laws, including without limitation the Americans with Disabilities Act (42 U.S.C. 12010 et. seq.) and all other public accommodation laws.</div>
